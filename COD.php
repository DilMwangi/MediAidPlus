...
<h2 class="text-center"> Thank you for shopping with MediAid+! The ordering process is now complete.</h2>
 ...
 <div class="container" >
  ...
  <div class="box">
    <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
      ...
      <br>
      <h4>Once your order has been approved, we will send a boda to delivery your medical supplies. We will also send you a notification by email. You can then print a format copy of your Receipt from within our Order Status System. </h4>
      <br>
