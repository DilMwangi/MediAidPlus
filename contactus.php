...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> MediAid+ </span>?</strong>
     <br>
...
<div class="paragraph1">
    ...
    <p><h3>We are here to answer any queries you may have about our <font color="green"><strong>MediAid+</strong></font> experiences. Reach out to us and we will respond as soon as we can.</h3></p>
        <p><h3>Even if there are some medical supplies you always wanted to purchase and couldn't find it on <font color="green"><strong>MediAid+</strong></font>, please do let us know and we here at <font color="green"><strong>MediAid+ promise to do our best to find it for you and suggest you the best of best.</strong></font> </h3></p>
        <p><b><h3>Contact Details of Team MediAid+ are given below:</h3></b></p>
        <p class="edit2">
