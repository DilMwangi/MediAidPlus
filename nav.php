      ...
      <div class="col-12 col-xs-12 col-sm-12">
        <section id="navbar">
          <nav class="navbar navbar-expand-lg navbar-dark bg-dark  fixed-top">
            ...
            <a class="navbar-brand text-white " href="index.php">MediAid+</a>
...
?>
                  ...
                  <?php
                      ...
                      $username= $_SESSION['login_user2'];
                        ...
                        <li class="nav-item me-5"><a class="nav-link"href="medicalsupplieslist.php"><span class=""></span> Medical Supplies </a></li>
              ...
              <?php } else if (isset($_SESSION['login_user3'])) {
                  $username= $_SESSION['login_user3'];
                    ...
                    <li class="nav-item me-5"><a class="nav-link"href="medslistDoctor.php"><span class=""></span> Medical Supplies </a></li>
