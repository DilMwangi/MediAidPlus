...
header("location: customerlogin.php"); //Redirecting to mystore Page
}
?>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="medslist.php"><span class="glyphicon glyphicon-cutlery"></span> MediAid+ </a></li>
...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, supplyname, price,  quantity, order_date, username, R_ID) 
              VALUES ('" . $F_ID . "','" . $supplyname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
