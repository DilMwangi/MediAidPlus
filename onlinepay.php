...
<html>
  ...
  <head>
    <title> Online Payment | MediAid+ </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="medslist.php"><span class="glyphicon glyphicon-plus"></span> Medical Supplies </a></li>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 pad-adjust">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" checked class="text-muted" required=""> Save details for faster payments. <a href="#">Learn More</a>
                                    </label>
                                </div>
                            </div>
                        </div>
