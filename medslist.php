...
?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-aos="fade-up" data-aos-offset="500">
      ...
      <div class="carousel-inner">
        ...
        <h1 class="text-white text-center" style="padding-top: 300px;"> Welcome to MediAid+ System</h1>
          <h5 class="text-white text-center"> A Reputable Service Dedicated to Serve our Clients Medical Supply Needs</h5>
...
<!-- Display all medical supplies from medicalsupplies table -->
<?php

require 'connection.php';
$conn = Connect();

$sql = "SELECT * FROM medicalsupplies WHERE options = 'ENABLE'  ORDER BY D_ID DESC";
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Sorry! No Medical Supplies are curently Available</h1> </label>
