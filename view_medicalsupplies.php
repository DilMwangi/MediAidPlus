...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/view_medicalsupplies.css">
...
<div class="container">
    <div class="jumbotron">
     <h1>Hello Manager! </h1>
     <p>View medical supplies from here</p>
...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> MEDICAL SUPPLIES LIST </h3>
...
$sql = "SELECT * FROM medicalsupplies f WHERE f.R_ID IN (SELECT r.R_ID FROM STORES r WHERE r.M_ID='$user_check') ORDER BY F_ID";
