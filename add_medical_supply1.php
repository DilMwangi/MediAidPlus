...
$R_IDsql = "SELECT STORES.R_ID FROM STORES, MANAGER WHERE STORES.M_ID='$user_check'";
...
$query = "INSERT INTO MEDICALSUPPLIES(name,price,description,R_ID,images_path) VALUES('" . $name . "','" . $price . "','" . $description . "','" . $R_ID ."','" . $images_path . "')";
...
if (!$success){
  ...
  <!--Javacript for back to top button....................................................................-->
    ...
    <div class="jumbotron">
     <h1>Sorry, </h1>
     <p>Please Enter your Store Details before Adding Medical Supplies.</p>
  ...
  <br>
  <p> MediAid+ | &copy All Rights Reserved </p>
  <br>
  </footer>
	</html>
	...
	echo "SUCCESS";
	header('Location: add_medical_supply.php');
}
